...
* Update the connection parameters for the database in the `discuss.db.core` namespace of your application.
...
Request middleware functions are located under the `discuss.middleware` namespace.
